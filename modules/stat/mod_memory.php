<div class='container'>
			...
			function poll_memory_usage() {
				...
				$.ajax({
				    ...
				    success: function(response){
				    	...
				    	document.getElementById("memory_percent_text").innerHTML = "Kullanılan: " + (100-((response/<?php echo $stat['memory_total']; ?>) *100)).toFixed(2) + "%";
				    	document.getElementById("memory_free_text").innerHTML = "Boş RAM: " + Number(response).toFixed(3) + " GB";
				    	document.getElementById("memory_used_text").innerHTML = "Kullanılan RAM: " + (<?php echo $stat['memory_total']; ?> - response).toFixed(3) + " GB";
				        return response;
				    }
				});
			}
	...
	<div class='ten columns'>
		<h3>RAM</h3>
		<p id="memory_percent_text">Kullanılan: <?php echo $stat['memory_percent'],"%"; ?></p>
		<p id="memory_total_text">Toplam RAM: <?php echo $stat['memory_total']," GB"; ?></p>
		<p id="memory_free_text">Boş RAM: <?php echo $stat['memory_free']," GB"; ?></p>
		<p id="memory_used_text">Kullanılan RAM: <?php echo $stat['memory_used']," GB"; ?></p>
	</div>
</div>