<div class='container'>
			...
			function poll_cpu_usage() {
				...
				$.ajax({
				    ...
				    success: function(response){
				    	...
				    	document.getElementById("cpu_usage_text").innerHTML = "İşlemci Kullanımı: " + response + "%";
				        return response;
				    }
				});
			}
	...
	<div class='ten columns'>
		<h3>CPU</h3>
		<p id="cpu_model_text">İşlemci Modeli: <?php echo $stat['cpu_model']; ?></p>
		<p id="cpu_usage_text">İşlemci Kullanımı: <?php echo $stat['cpu_usage'],"%"; ?></p>
	</div>
</div>